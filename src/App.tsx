...
const App: React.FC = () => {
  ...
  // ✅ Infinite Scroll — ref দিয়ে চেক, observer একবারই তৈরি হয়
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      { rootMargin: '300px' } // ৩০০px আগে trigger — user আগেই পাবে
    );
    observer.observe(sentinel);
    return () => observer.disconnect();
  }, []); // ✅ একবারই setup হয়, বারবার recreate হয় না
      ...
      <main className={`px-4 max-w-7xl mx-auto relative z-10 ${activeTab === 'home' ? '-mt-2' : 'pt-20'}`}>
        ...
        {activeTab === 'home' && (
            <>  
                ...
                <div className="sticky top-0 z-30 bg-[#0d0d10] -mx-4 px-4 py-3 mb-6 border-b border-white/5" style={{transform:"translateZ(0)",willChange:"transform"}}>
